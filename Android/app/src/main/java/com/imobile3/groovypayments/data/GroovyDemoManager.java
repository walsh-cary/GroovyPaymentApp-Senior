...
//                    "Chicken, lettuce, tomato and mayo",
//                    750L, 200L,
//                    GroovyIcon.AlarmClock, GroovyColor.Blue));
//
        ...
        public void run() {
            ...
            for (CartEntity cartEntity : cartEntities) {
                ...
                cart.setProducts(TestDataRepository.getInstance()
                        .getCartProducts(TestDataRepository.Environment.GroovyDemo, cartEntity));
                cart.setTaxes(TestDataRepository.getInstance()
                        .getCartTaxes(TestDataRepository.Environment.GroovyDemo, cartEntity));
